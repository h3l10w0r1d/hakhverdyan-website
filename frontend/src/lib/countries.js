// Generated from world-countries dataset (cca2, common name, ITU calling code).
// Flags are derived at runtime from the ISO 3166-1 alpha-2 code — see flagEmoji().
export const COUNTRIES = [
  ...
  { code: "TF", name: "French Southern and Antarctic Lands", dial: "+262" },
  ...
  { code: "SH", name: "Saint Helena, Ascension and Tristan da Cunha", dial: "+2" },
  ...
  { code: "SJ", name: "Svalbard and Jan Mayen", dial: "+4779" },
  ...
  { code: "UM", name: "United States Minor Outlying Islands", dial: "+268" },
  { code: "VI", name: "United States Virgin Islands", dial: "+1340" },
  { code: "UY", name: "Uruguay", dial: "+598" },
  { code: "UZ", name: "Uzbekistan", dial: "+998" },
  { code: "VU", name: "Vanuatu", dial: "+678" },
  { code: "VA", name: "Vatican City", dial: "+3" },
  { code: "VE", name: "Venezuela", dial: "+58" },
  { code: "VN", name: "Vietnam", dial: "+84" },
  { code: "WF", name: "Wallis and Futuna", dial: "+681" },
  { code: "EH", name: "Western Sahara", dial: "+2" },
...
export const DEFAULT_COUNTRY_CODE = "AM";
